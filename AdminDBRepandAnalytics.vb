...
Public Class AdminDBRepandAnalytics
    ...
    Private Sub DGVStockTrackTransaction_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGVStockTrackTransaction.CellContentClick
